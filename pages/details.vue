        ...
        <div class="row" :class="autoClass">
          <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12" :class="$q.platform.is.desktop ? '' : 'q-px-md'">
            ...
            <div class="q-mt-sm">
              ...
              <div class="text-caption q-mt-sm text-grey-8 text-weight-bold">Delivery by: <span class="text-black">Tue,
                  Mar 3</span>
              </div>
          ...
          <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 q-mt-md q-pt-xs q-pl-lg">
            ...
            <div>
              <q-rating v-model="rating_point" max="5" size="2em" color="orange" icon="star_border" icon-selected="star"
            ...
            <q-list dense bordered padding class="no-border q-mt-lg q-pr-xl">
              ...
              <q-item style="padding-left: 0 !important;" v-ripple>
                ...
                <span style="margin-top: 2px"
                  class="text-caption text-weight-bold text-grey-8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;6</span>
              </q-item>
              <q-item style="padding-left: 0 !important;" v-ripple>
                ...
                <q-linear-progress class="q-ml-sm  q-mr-sm" style="margin-top: 5px;" size="13px" :value="0.1" />
                <span style="margin-top: 2px"
                  class="text-caption text-weight-bold text-grey-8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3</span>
              </q-item>
              <q-item style="padding-left: 0 !important;" v-ripple>

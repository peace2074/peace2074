<template>
  <NuxtLayout name="default">
    <div class="p-3 flex-row gap-1">
      <h1 class="text-h2"><strong>Privacy Policy for waelio.com</strong></h1>

      <p class="text-justify">
        At Waelio.com, accessible from https://waelio.com, one of our main priorities is
      ...
      <p class="text-justify">
        ...
        collect in Waelio.com. This policy is not applicable to any information collected
      ...
      <p>
        Waelio.com follows a standard procedure of using log files. These files log
      ...
      <p>
        If you have additional questions or require more information about our Privacy
        Policy, do not hesitate to contact us
        <a href="mailto:wahbehw@gmail.com?subject=EMail%20from%20waelio.com">Here</a>.
      </p>
      <h2 class="text-3">Consent</h2>
      ...
      <p>
        ...
        appear on Waelio.com, which are sent directly to users' browser. They
      ...
      <p>
        Note that Waelio.com has no access to or control over these cookies that are used
      ...
      <p>
        Waelio.com's Privacy Policy does not apply to other advertisers or websites. Thus,
      ...
      <p>
        Waelio.com does not knowingly collect any Personal Identifiable Information from

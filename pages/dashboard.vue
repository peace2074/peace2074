          ...
          <q-card flat bordered class="">
            <q-card-section class="row">
              <div class="text-h6 col-12">
                Sales vs Goals
                <q-btn flat dense icon="fas fa-download" class="float-right" color="grey-8" @click="SaveImage('bar')">
            ...
            <q-card-section>
              <IEcharts ref="bar" :option="barChartOption" :resizable="true" style="height:220px" />
            </q-card-section>
          </q-card>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <q-card flat bordered class="">
            <q-card-section class="row">
              <div class="text-h6 col-12">
                Market Share & Growth
                <q-btn flat dense icon="fas fa-download" class="float-right" color="grey-8" @click="SaveImage('line')">
                  <q-tooltip>Download</q-tooltip>
                </q-btn>
              </div>
            </q-card-section>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <q-card flat bordered class="">
            <q-card-section class="row">
              <div class="text-h6 col-12">
                Sales vs Quota
                <q-btn flat dense icon="fas fa-download" class="float-right" color="grey-8" @click="SaveImage('gauge')">
                  <q-tooltip>Download</q-tooltip>
                </q-btn>
              </div>
            </q-card-section>
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <q-card flat bordered class="">
          <q-card-section>
            <div class="text-h6">
              Key Competitors
              <q-btn flat dense icon="fas fa-download" class="float-right" color="grey-8" @click="SaveImage('pie')">
                <q-tooltip>Download</q-tooltip>
              </q-btn>
            </div>
          </q-card-section>
        ...
        <q-card flat bordered class="">
          <q-card-section>
            <div class="text-h6">
              ...
              <q-btn flat dense icon="fas fa-download" class="float-right" color="grey-8" @click="SaveImage('stack_bar')">
                <q-tooltip>Download</q-tooltip>
              </q-btn>
            </div>
          </q-card-section>
    ...
    <div class="row q-col-gutter-sm q-ma-xs">
      <div class="col-12">
        <q-card flat bordered class="bg-white">
          <q-table
            v-model:pagination="pagination" title="All Activities" :data="data" :hide-header="mode === 'grid'" :columns="columns"
            row-key="name" :grid="mode == 'grid'" :filter="filter"
          >
            <template #top-right="props">
              ...
              <q-btn
                v-if="mode === 'list'" flat round dense
              ...
              <q-btn
                v-if="!props.inFullscreen" flat round dense

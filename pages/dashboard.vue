        ...
        <q-card flat bordered class="">
          <q-card-section>
            <div class="text-h6">Sales Pipeline by Sales Rep
              <q-btn flat dense icon="fas fa-download" class="float-right" @click="SaveImage('stack_bar')" color="grey-8">
                <q-tooltip>Download</q-tooltip>
              </q-btn>
            </div>
          </q-card-section>
            ...
            <template v-slot:top-right="props">
              ...
              <q-btn flat round dense :icon="props.inFullscreen ? 'fullscreen_exit' : 'fullscreen'"
                ...
                <q-tooltip :disable="$q.platform.is.mobile"
                  v-close-popup>{{ props.inFullscreen ? 'Exit Fullscreen' : 'Toggle Fullscreen' }}
                </q-tooltip>
              </q-btn>

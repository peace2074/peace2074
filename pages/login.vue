<template>
  <q-page class="flex flex-center" style="font-family: Lato;">
    ...
    <q-card :style="$q.platform.is.desktop ? 'width:55%;' : 'width:100%;'"
      class="row my-card items-center q-pa-none q-ma-none shadow-24">
      <q-card-section v-if="$q.platform.is.desktop" class="col q-pa-md q-ma-auto" style="background-color: #1f509e"
        horizontal>

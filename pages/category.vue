        ...
        <q-card class="q-mr-sm no-shadow">
          ...
          <transition-group appear enter-active-class="animated fadeInLeft">
            <q-list v-for="item in filters_list" :key="item.label">
              ...
              <q-item class="q-py-none text-weight-bold text-indigo text-caption cursor-pointer" style="min-height: 10px">
                View All
              </q-item>
            </q-list>
          </transition-group>
      ...
      <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
        <div class="q-pa-md row items-start q-gutter-md">
          <q-card @click="$router.push('/details')" class="cursor-pointer" :class="class_val"
            @mouseover="class_val = 'my-card shadow-20'" @mouseleave="class_val = 'my-card shadow-'">

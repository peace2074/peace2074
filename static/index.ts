...
export const links1: linksT[] = [
  ...
  {
    icon: "contact_page",
    text: "navigation.ContactPageTitle",
    dist: "/contact",
  },
...
export const sponsors: {
  ...
  {
    name: "Amazon",
    img: "https://d1.awsstatic.com/training-and-certification/Certification%20Badges/AWS-Certified_Cloud-Practitioner_512x512.bc006f14f986fa4f3ca238b0b62be458ce1fb5ce.png",
    url: "https://aws.amazon.com",
  },
  {
    name: "Amplify",
    img: "https://docs.amplify.aws/assets/ogp.jpg",
...
export type DST = {
  [key in keyof wtypes]: StyleT;
};
export const defaultStyles: DST[] = {
  // @ts-ignore
  info: {
    icon: "info",
    color: "info",
